...
//Queue
export const RMQ_Q_RPC = `service.api-rpc`;

export const RMQ_Q_AUTH_ROLE_PERMISSION_CREATE = `service.api-role.permission.create`;
export const RMQ_Q_RK_AUTH_ROLE_PERMISSION_CREATE = 'auth.api-role.permission.create';

export const RMQ_Q_AUTH_ROLE_PERMISSION_DELETE = `service.api-role.permission.delete`;
