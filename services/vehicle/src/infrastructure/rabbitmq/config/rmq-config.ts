...
//Queues
export const RMQ_Q_CUSTOMER_CREATE = "vehicle-api_customer-api.customer.create";
export const RMQ_Q_RK_CUSTOMER_CREATE = "customer-api_customer.create";

export const RMQ_Q_CUSTOMER_UPDATE = "vehicle-api_customer-api.customer.update";
export const RMQ_Q_RK_CUSTOMER_UPDATE = "customer-api_customer.update";

export const RMQ_Q_SERVICE_CREATE = "vehicle-api_service-api.service.create";
export const RMQ_Q_RK_SERVICE_CREATE = "service-api_service.create";

export const RMQ_Q_SERVICE_UPDATE = "vehicle-api_service-api.service.update";
