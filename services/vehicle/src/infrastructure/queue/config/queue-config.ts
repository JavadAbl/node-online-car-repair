...
export const QUEUE_EVENT_TECHNICIAN_CREATE = "vehicle.event-technician.create";
export const WORKER_EVENT_TECHNICIAN_CREATE_CONCURRENCY = 1;
export const WORKER_EVENT_TECHNICIAN_CREATE_INTERVAL_DELAY = 2500;

export const QUEUE_EVENT_TECHNICIAN_UPDATE = "vehicle.event-technician.update";
export const WORKER_EVENT_TECHNICIAN_UPDATE_CONCURRENCY = 1;
export const WORKER_EVENT_TECHNICIAN_UPDATE_INTERVAL_DELAY = 2500;
